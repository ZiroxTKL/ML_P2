...
% --- Compatibilidad de motor: pdfLaTeX (Overleaf) y XeLaTeX (tectonic) ---
\usepackage{iftex}
\ifPDFTeX
...
(t-SNE y UMAP), proyectando el espacio MFCC estandarizado a dos y tres dimensiones
...
AIC, Silhouette, Davies--Bouldin y Calinski--Harabasz; para DBSCAN se seleccionó
...
de las capas de Dropout y Batch Normalization sobre la estabilidad de las curvas de
...
gradiente (XGBoost y LightGBM), evaluando F1-Score macro y matrices de confusión
...
\midrule
Integrante 1 & 33\,\% & [Placeholder: detallar tareas] \\
Integrante 2 & 33\,\% & [Placeholder: detallar tareas] \\
Integrante 3 & 34\,\% & [Placeholder: detallar tareas] \\
\bottomrule
\end{tabular}
\end{table}
